...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox_Camera->setObjectName("groupBox_Camera");
        ...
        comboImage_Resolution->setObjectName("comboImage_Resolution");
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 529, 202));
        ...
        comboViedo_Quality->addItem(QString());
        comboViedo_Quality->addItem(QString());
        comboViedo_Quality->setObjectName("comboViedo_Quality");
